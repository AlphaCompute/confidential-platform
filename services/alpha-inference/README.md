...
- `GET /healthz` (process only) and `GET /ready` need no bearer. Readiness requires the default model's gateway verification and, when enabled, successful input and output guardrail probes.
